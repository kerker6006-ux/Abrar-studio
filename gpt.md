...
> Read this file before changing the project. It is the canonical high-level handoff for Abrar Studio 3.0.4. After reading it, inspect the implementation files named in the module map before making technical claims or edits.
