...
> Read this file before changing the project. It is the canonical high-level handoff for Abrar Studio 3.1.1. After reading it, inspect the implementation files named in the module map before making technical claims or edits.

## 1. Project identity

- **Product:** Abrar Studio
- **Current source version:** 3.1.1
